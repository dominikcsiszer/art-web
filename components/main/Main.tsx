      ...
      <div className="max-w-7xl mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 md:ml-24 pt-6 flex flex-col md:items-start md:text-left mb-40 items-center text-center">
          ...
          <div className="flex justify-center">
            <a
              className="inline-flex items-center px-5 py-3 mt-2 font-medium text-gray-900 transition duration-500 ease-in-out transform border rounded-lg bg-white hover:bg-gray-200"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <div className="py-24 md:py-36">
            ...
            <input
              ...
              type="email"
              autoComplete="email"
              className="border border-gray-600 w-1/4 pr-2 pl-2 py-3 mt-2 rounded-md text-gray-200 font-semibold bg-gray-800 focus:border-gray-400"
            ></input>
            <a
              className="inline-flex items-center px-14 py-3 mt-2 ml-2 font-medium text-gray-900 transition duration-500 ease-in-out transform border rounded-lg bg-white hover:bg-gray-200"
              href="/"
            >
